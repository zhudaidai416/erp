...
export const menuData_2 = [
  ...
  },
  {
    ...
    label: '销售单',
    path: '/sale/sales',
    component: 'sale/sales/SaleOrder',
    children: [
      {
        key: '2.1.1',
        label: '新增销售单',
        path: '/sale/addSaleOrder',
        component: 'sale/addSaleOrder/AddSaleOrder',
      },
      {
        key: '2.1.2',
        label: '销售单详情',
        path: '/sale/detailsSale',
        component: 'sale/detailsSale/DetailsSale'
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        label: '收款单',
        path: '/receipt',
        component: 'Funds/Receipt/Receipt',
      },
      {
        key: '5.1.1.1',
        label: '新增收款单',
        path: '/receipt/add_receipt',
        component: 'Funds/Receipt/addReceipt',
        hidden: true,
      },
      {
        key: '5.1.1.2',
        label: '详情收款单',
        path: '/receipt/detail_receipt/:id',
        component: 'Funds/Receipt/detailReceipt',
        hidden: true,
      },
      {
        key: '5.1.2',
        label: '付款单',
        path: '/payment',
        component: 'Funds/Payment/Payment',
      },
      {
        key: '5.1.3',
        label: '其他收支',
        path: '/others',
        component: 'Funds/Others/Others',
      },
      {
        key: '5.1.4',
        label: '资金流水',
        path: '/account',
        component: 'Funds/Account/Account',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: 'components/setting/TemplateMessage',
        hidden: true,
      },
    ],
  },
